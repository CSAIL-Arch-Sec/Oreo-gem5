...
def main():
    args_list = [
        ...
        # ["kvm", "o3", "0,0,0", "c,0,0", None, "2024-04-05-05-23-35", "", Path("/root/experiments/command-scripts") / "set_protection_test.rcS"],
        # ["kvm", "o3", "1,1,0", "c,0,0", None, "2024-04-05-05-23-35", "", Path("/root/experiments/command-scripts") / "set_protection_test.rcS"],
    ]
